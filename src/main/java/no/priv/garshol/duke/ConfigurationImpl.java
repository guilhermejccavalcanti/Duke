...
public class ConfigurationImpl implements Configuration {
   ...
   */
    public void setProperties(List<Property> props) {
        ...
        for (Property prop : props) properties.put(prop.getName(), prop);
   ...
   */
    ...
    private void findLookupProperties() {
        ...
        for (Property prop : properties.values()) // or which have lookup turned off explicitly
    ...
    public Configuration copy() {
        ...
        for (DataSource src : datasources) copy.addDataSource(0, src);
        for (DataSource src : group1) copy.addDataSource(1, src);
        for (DataSource src : group2) copy.addDataSource(2, src);
        ...
        for (Property p : proplist) newprops.add(p.copy());
